...
def crossVal(estimators, X_train, y_train, k=5):
    ...
    for train_index, test_index in splits:
        ...
        for estimator in estimators:
            X_train_fold, X_test_fold = X_train.values[train_index], X_train.values[test_index]  # nopep8
            y_train_fold, y_test_fold = y_train.values[train_index], y_train.values[test_index]  # nopep8
